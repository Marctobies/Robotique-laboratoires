...
# J'ai décidé de faire un fichier séparé pour la collecte d'images
# plutôt que de l'inclure dans un la classe ia, car cela facilite la gestion des images
# et rend le code plus lisible pour moi-même
...
def main():
    ...
    try:
        while key != ord('x'):
            ...
            camera.afficher_image(frame, "Appuyez sur O pour obstacle ou L pour libre")
